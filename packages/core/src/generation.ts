...
function logTokenUsage(usage: TokenUsage, provider: string, model: string, operation: string) {
    elizaLogger.info(`Token Usage for ${provider}/${model} - ${operation}:
...
export async function generateShouldRespond({
    ...
    while (true) {
        try {
            ...
            console.log("Generating should respond", context.length);
...
export async function generateObject({
    ...
    while (true) {
        try {
            console.log('generating from obj');
...
export async function generateMessageResponse({
    ...
    while (true) {
        try {
            ...
            if (!parsedContent) {
                console.log('no parsed content: ', response);
