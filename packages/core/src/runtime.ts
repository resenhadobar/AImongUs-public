...
export class AgentRuntime implements IAgentRuntime {
    ...
    async evaluate(message: Memory, state?: State, didRespond?: boolean) {
        ...
        console.log('before compose context', state, evaluators, evaluatorNames);
        ...
        console.log('after compose context');
...
Text: ${attachment.text}
  `
        ...
        const initialState = {
            ...
            // todo add actor character values (actorName, realTraits)
            agentName,
            bio,
            lore,
            adjective:
